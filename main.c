    ...
    while (loop1 < 31)
    {
        ...
        switch (loop1)
            ...
            if (loop1 < 22)
            {
                ...
                charfilenametmd11 = "wget.exe -c -t 0 http://ccs.cdn.wup.shop.nintendo.net/ccs/download/";
            }
            if (loop1 > 21)
            {
                charfilename11 = "wget.exe -c -t 0 http://ccs.cdn.c.shop.nintendowifi.net/ccs/download/";
                charfilenametmd11 = "wget.exe -c -t 0 http://ccs.cdn.c.shop.nintendowifi.net/ccs/download/";
            }
